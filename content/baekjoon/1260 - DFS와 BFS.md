...
- 아래는 DFS와 BFS의 chat GPT코드의 개념이다.
    ...
    ![DFS](https://github.com/JS970/JS970.github.io/blob/main/content/baekjoon/BFS.png?raw=true)
    ...
    ![BFS](https://github.com/JS970/JS970.github.io/blob/main/content/baekjoon/DFS.png?raw=true)
